...
public class ShortAdapter extends RecyclerView.Adapter<ShortAdapter.MyViewHolder> {
    private Activity activity;
    private List<Games> mData;
    String mygameurl;

    public ShortAdapter(Activity activity, String mygameurl, List<Games> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new MyViewHolder(LayoutInflater.from(activity).inflate(R.layout.game_list_row_4, viewGroup, false));
    }
