...
public class AtmeLoad {

    public static void loadAtme(Activity activity, RecyclerView qurekalist) {
    ...
    public static void loadAtmePagerAdapter(Activity activity , CardView cardView, UltraViewPager ultraViewPager){
        if (FirstActivity.sharedPreferences.getString("check_qureka_mode", "").equalsIgnoreCase("on")) {

            int[] qurekabanner = {R.drawable.atme1, R.drawable.atme2, R.drawable.atme3, R.drawable.atme4, R.drawable.atme5};
